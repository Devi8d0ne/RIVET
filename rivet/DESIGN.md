...
The owner accepted the generated studio concept on September 7, 2026, then selected RIVET as the product name and a camera-aperture R as its identity. The original concept remains the layout and color reference.
...
| --- | --- | --- |
| Product name | RIVET in the UI, runtime, package, launchers, and program graphics | One consistent identity across Android, Linux, browser, and GitHub. |
...
RIVET uses its own directory names, storage keys, API identifiers, and locally bundled icon assets. Fonts, media composition, and controls make no external asset requests. Live destinations and upload links remain user supplied.
